...
import com.minh.Online.Food.Ordering.request.LoginRequest;
import com.minh.Online.Food.Ordering.response.AuthResponse;
import com.minh.Online.Food.Ordering.repository.CartRepository;
import com.minh.Online.Food.Ordering.service.CustomerUserDetailsService;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> createUserHandler(@RequestBody User user) throws Exception {
        ...
        if (isEmailExists != null) {
            throw new Exception("email is already from another account");
        }
